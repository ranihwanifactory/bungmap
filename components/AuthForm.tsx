...
export const AuthForm = () => {
  ...
  const handleGuestLogin = async () => {
    try {
      ...
      setError('손님 입장 중 오류가 발생했습니다. 잠시 후 다시 시도해주세요.');
    }
  };
    ...
    <div className="min-h-screen bg-bung-50 flex items-center justify-center p-4">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border border-bung-100">
        <div className="flex flex-col items-center mb-8">
           ...
           <h1 className="text-3xl font-black text-bung-900 tracking-tight">붕어빵지도</h1>
        ...
        <div className="my-6 flex items-center">
            ...
            <span className="flex-shrink-0 mx-4 text-bung-400 text-xs font-medium">간편 로그인</span>
            <div className="flex-grow border-t border-bung-200"></div>
        </div>
        ...
        <div className="space-y-3">
            ...
            <button
                ...
                className="w-full py-3 border border-gray-200 bg-gray-50 text-gray-600 rounded-xl font-bold flex items-center justify-center gap-3 hover:bg-gray-100 transition-all shadow-sm hover:shadow-md"
            >
